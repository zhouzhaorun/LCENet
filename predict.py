...
import torch
import argparse
from utils import t_model, mkdir_fun
...
parser.add_argument('--test_dir', help='Set the test_dir', default='./sample/', type=str)
parser.add_argument('--save_dir', help='Set the save_dir', default='./result/', type=str)
...
parser.add_argument('--checkpoint_dir', help='directory for checkpoints', default='./checkpoint/', type=str)
args = parser.parse_args()

device = torch.device("cuda:0" if torch.cuda.is_available() else "cpu")

mkdir_fun(args.save_dir)
